...
import lpConfig, { LPPoolName, LPType } from 'src/util/lpConfig';
    ...
    children: [
      {
        ...
        poolOn: LPPoolName.CURVE,
        addLiquidityUrl: 'https://curve.fi/reth',
        lpContract: lpConfig.rEthLpContract,
        stakeTokenAddress: '',
        toDate: '--',
        totalReward: '--',
        tvl: '--',
      ...
      },
      {
        platform: 'Ethereum',
        type: LPType.EARN,
        poolOn: LPPoolName.UNISWAP,
        poolIndex: 0,
        lpContract: lpConfig.rETHLpContract2(),
        apy: [
          {
            index: 0,
            apy: '0',

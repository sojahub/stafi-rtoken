...
import rSOL from "src/assets/images/selected_r_sol.svg";
import Button from "src/shared/components/button/button";
import Input from "src/shared/components/input/amountInput";
import EditInput from "src/shared/components/input/editAddresInput";
    ...
    <LeftContent className="stafi_stake_redeem_context">
      ...
      <div className="input_panel">
        ...
        <div className="balance">
          ...
          {props.tokenAmount == "--"
            ? "--"
            : NumberUtil.handleFisAmountToFixed(props.tokenAmount)}
        </div>
      </div>
      {/* <div className="btns">
      ...
      <EditInput
        value={props.address}
        onEdit={(e: boolean) => {
          const r = props.onInputConfirm && props.onInputConfirm(e);
          if (r) {
            setInputEdit(e);
          }
          return r;

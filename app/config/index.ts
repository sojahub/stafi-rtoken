...
export default {
  ...
  txHashAndBlockhashURl: {
    ...
    atomURL:
      "https://docs.stafi.io/rproduct/ratom-solution/staker-guide/recovery-function#2-the-way-to-get-txhash",
  },
  rAtomChainId: () => {
    if (!isdev()) {
      return "cosmoshub-4";
  ...
  uniswap: {
    ...
    rethURL_pair:
      "https://v2.info.uniswap.org/pair/0x5f49da032defe35489ddb205f3dc66d8a76318b3",
    rfisURL:

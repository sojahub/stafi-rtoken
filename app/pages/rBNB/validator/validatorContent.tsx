...
export default function Index(props: Props) {
  return (
    <LeftContent className='stafi_validator_context'>
      <label className='title'>Register as a OV on BSC</label>
      <div className='describe'>
        OV(Original Validator) is a block producer of BSC chain which can receive delegated BNB on chain and get
        incentive reward from joining consensus.
      </div>
      <div className='sub_title'>Prerequisites</div>
      <div className='describe'>
        1. You have registered as a validator on BSC Chain <br />
      ...
      <div className='describe'>
        ...
        validators on BSC. As the number of rBNB increases, validator will be open to the community
      </div>
      <div className='btns'>
        <Button
          onClick={() => {

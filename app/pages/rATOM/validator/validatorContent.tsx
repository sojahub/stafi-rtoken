...
export default function Index(props:Props){
    return <LeftContent className="stafi_rDOT_validator_context">
        ...
        OV(Original Validator) is a block producer of Kusama chain which can receive delegated ATOM on chain and get incentive reward from joining consensus.
        </div>
        ...
        <div className="describe">
        In the start-up phase, in order to maximize revenue, StaFi chain will automatically nominate the elected validators on Kusama. As the number of rATOM increases, validator will be open to the community
        </div>
        <div className="btns">
            <Button  onClick={()=>{
